...
typedef void (*UniffiCallbackInterfaceMessageCallbackMethod0)(uint64_t, void* _Nonnull, 
        RustCallStatus *_Nonnull uniffiCallStatus
    );
...
typedef void (*UniffiCallbackInterfaceSyncConversationsCallbackMethod0)(uint64_t, RustBuffer, uint32_t, void* _Nonnull, 
        RustCallStatus *_Nonnull uniffiCallStatus
    );
...
uint64_t uniffi_restsend_sdk_fn_method_client_sync_chat_logs(void*_Nonnull ptr, RustBuffer topic_id, RustBuffer last_seq, uint32_t limit, uint64_t callback
);
#endif
...
uint64_t uniffi_restsend_sdk_fn_method_client_sync_conversations(void*_Nonnull ptr, RustBuffer updated_at, uint32_t limit, int8_t sync_logs, RustBuffer sync_logs_limit, RustBuffer sync_logs_max_count, uint64_t callback
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_FN_FUNC_ATTACHMENT_FROM_LOCAL
#define UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_FN_FUNC_ATTACHMENT_FROM_LOCAL
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_FN_FUNC_ATTACHMENT_FROM_URL
#define UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_FN_FUNC_ATTACHMENT_FROM_URL
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_CHECKSUM_FUNC_ATTACHMENT_FROM_LOCAL
#define UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_CHECKSUM_FUNC_ATTACHMENT_FROM_LOCAL
uint16_t uniffi_restsend_sdk_checksum_func_attachment_from_local(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_CHECKSUM_FUNC_ATTACHMENT_FROM_URL
#define UNIFFI_FFIDEF_UNIFFI_RESTSEND_SDK_CHECKSUM_FUNC_ATTACHMENT_FROM_URL
