...
public protocol ClientProtocol : AnyObject {
    ...
    func syncChatLogs(topicId: String, lastSeq: Int64?, limit: UInt32, callback: SyncChatLogsCallback) async 
    
    func syncConversations(updatedAt: String?, limit: UInt32, syncLogs: Bool, syncLogsLimit: UInt32?, syncLogsMaxCount: UInt32?, callback: SyncConversationsCallback) async 
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_do_send(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(topicId),FfiConverterTypeContent.lower(content),FfiConverterOptionCallbackInterfaceMessageCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_rust_buffer,
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_do_send_file(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(topicId),FfiConverterTypeAttachment.lower(attachment),FfiConverterOptionSequenceString.lower(mentions),FfiConverterBool.lower(mentionAll),FfiConverterOptionString.lower(replyId),FfiConverterOptionCallbackInterfaceMessageCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_rust_buffer,
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_do_send_image(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(topicId),FfiConverterTypeAttachment.lower(attachment),FfiConverterOptionSequenceString.lower(mentions),FfiConverterOptionString.lower(replyId),FfiConverterOptionCallbackInterfaceMessageCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_rust_buffer,
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_do_send_video(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(topicId),FfiConverterTypeAttachment.lower(attachment),FfiConverterString.lower(duration),FfiConverterOptionSequenceString.lower(mentions),FfiConverterBool.lower(mentionAll),FfiConverterOptionString.lower(replyId),FfiConverterOptionCallbackInterfaceMessageCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_rust_buffer,
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_download_file(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(fileUrl),FfiConverterCallbackInterfaceDownloadCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_rust_buffer,
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
...
open func fetchChatLogsDesc(topicId: String, lastSeq: Int64?, limit: UInt32)async throws  -> GetChatLogsResult {
    return
        try  await uniffiRustCallAsync(
            ...
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
            freeFunc: ffi_restsend_sdk_rust_future_free_rust_buffer,
            liftFunc: FfiConverterTypeGetChatLogsResult.lift,
            errorHandler: FfiConverterTypeClientError.lift
        )
}
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_send_chat_request_via_connection(
                    self.uniffiClonePointer(),
                    FfiConverterTypeChatRequest.lower(req),FfiConverterOptionCallbackInterfaceMessageCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_rust_buffer,
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
...
open func setCallback(callback: Callback?) {try! rustCall() {
...
open func syncChatLogs(topicId: String, lastSeq: Int64?, limit: UInt32, callback: SyncChatLogsCallback)async  {
    return
        try!  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_sync_chat_logs(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(topicId),FfiConverterOptionInt64.lower(lastSeq),FfiConverterUInt32.lower(limit),FfiConverterCallbackInterfaceSyncChatLogsCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_void,
            completeFunc: ffi_restsend_sdk_rust_future_complete_void,
...
open func syncConversations(updatedAt: String?, limit: UInt32, syncLogs: Bool, syncLogsLimit: UInt32?, syncLogsMaxCount: UInt32?, callback: SyncConversationsCallback)async  {
    return
        try!  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_sync_conversations(
                    self.uniffiClonePointer(),
                    FfiConverterOptionString.lower(updatedAt),FfiConverterUInt32.lower(limit),FfiConverterBool.lower(syncLogs),FfiConverterOptionUInt32.lower(syncLogsLimit),FfiConverterOptionUInt32.lower(syncLogsMaxCount),FfiConverterCallbackInterfaceSyncConversationsCallback.lower(callback)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_void,
            completeFunc: ffi_restsend_sdk_rust_future_complete_void,
        ...
        try!  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_restsend_sdk_fn_method_client_try_sync_chat_logs(
                    self.uniffiClonePointer(),
                    FfiConverterTypeConversation.lower(conversation),FfiConverterOptionUInt32.lower(limit)
                )
            },
            pollFunc: ffi_restsend_sdk_rust_future_poll_rust_buffer,
            completeFunc: ffi_restsend_sdk_rust_future_complete_rust_buffer,
...
public struct ChatRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(type: String, chatId: String, code: UInt32, topicId: String, seq: Int64, attendee: String, attendeeProfile: User?, createdAt: String, content: Content?, e2eContent: String?, message: String?, source: String?) {
        self.type = type
        self.chatId = chatId
        self.code = code
        self.topicId = topicId
...
public struct Content {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(type: String, encrypted: Bool, checksum: UInt32, text: String, placeholder: String, thumbnail: String, duration: String, size: UInt64, width: Float, height: Float, mentions: [String], mentionAll: Bool, reply: String, replyContent: String?, createdAt: String, attachment: Attachment?, extra: [String: String]?, unreadable: Bool) {
        self.type = type
...
fileprivate struct UniffiCallbackInterfaceCallback {

    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceCallback = UniffiVTableCallbackInterfaceCallback(
        onConnected: { (
            uniffiHandle: UInt64,
        ...
        onSystemRequest: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onSystemRequest(
                     req: try FfiConverterTypeChatRequest.lift(req)
                )
            }
        ...
        onNewMessage: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onNewMessage(
                     topicId: try FfiConverterString.lift(topicId),
                     message: try FfiConverterTypeChatRequest.lift(message)
                )
            }
        ...
        onConversationRemoved: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onConversationRemoved(
                     conversatioId: try FfiConverterString.lift(conversatioId)
                )
            }
        ...
        uniffiFree: { (uniffiHandle: UInt64) -> () in
            let result = try? FfiConverterCallbackInterfaceCallback.handleMap.remove(handle: uniffiHandle)
            if result == nil {
                print("Uniffi callback interface Callback: handle missing in uniffiFree")
            }
        }
    )
}

private func uniffiCallbackInitCallback() {
    uniffi_restsend_sdk_fn_init_callback_vtable_callback(&UniffiCallbackInterfaceCallback.vtable)
}

// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceCallback {
    fileprivate static var handleMap = UniffiHandleMap<Callback>()
}
        ...
        onFail: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onFail(
                     e: try FfiConverterTypeClientError.lift(e)
                )
            }
        ...
        onAttachmentUpload: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onAttachmentUpload(
                     result: try FfiConverterTypeUpload.lift(result)
                )
            }
...
fileprivate struct UniffiCallbackInterfaceSyncChatLogsCallback {
    ...
    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceSyncChatLogsCallback = UniffiVTableCallbackInterfaceSyncChatLogsCallback(
        onSuccess: { (
            uniffiHandle: UInt64,
            r: RustBuffer,
            uniffiOutReturn: UnsafeMutableRawPointer,
            ...
            let makeCall = {
                ...
                return uniffiObj.onSuccess(
                     r: try FfiConverterTypeGetChatLogsResult.lift(r)
                )
            }
...
fileprivate struct FfiConverterCallbackInterfaceSyncChatLogsCallback {
    fileprivate static var handleMap = UniffiHandleMap<SyncChatLogsCallback>()
}
...
fileprivate struct UniffiCallbackInterfaceSyncConversationsCallback {
    ...
    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceSyncConversationsCallback = UniffiVTableCallbackInterfaceSyncConversationsCallback(
        onSuccess: { (
            uniffiHandle: UInt64,
...
fileprivate struct FfiConverterCallbackInterfaceSyncConversationsCallback {
    fileprivate static var handleMap = UniffiHandleMap<SyncConversationsCallback>()
}
...
fileprivate struct UniffiCallbackInterfaceUploadCallback {
    ...
    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceUploadCallback = UniffiVTableCallbackInterfaceUploadCallback(
        onProgress: { (
            uniffiHandle: UInt64,
            progress: UInt64,
            total: UInt64,
...
fileprivate struct FfiConverterCallbackInterfaceUploadCallback {
    fileprivate static var handleMap = UniffiHandleMap<UploadCallback>()
}
...
public func attachmentFromLocal(fileName: String, filePath: String, isPrivate: Bool) -> Attachment {
    return try!  FfiConverterTypeAttachment.lift(try! rustCall() {
...
public func setCurrentUser(root: String, userId: String)throws  {try rustCallWithError(FfiConverterTypeClientError.lift) {
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_restsend_sdk_checksum_func_attachment_from_local() != 31248) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_func_attachment_from_url() != 46087) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_restsend_sdk_checksum_method_client_set_callback() != 8700) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_restsend_sdk_checksum_method_client_sync_chat_logs() != 42341) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_client_sync_conversations() != 15224) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_restsend_sdk_checksum_method_callback_on_connected() != 36665) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_callback_on_connecting() != 39156) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_callback_on_token_expired() != 57669) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_callback_on_net_broken() != 21721) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_callback_on_kickoff_by_other_client() != 33480) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_callback_on_system_request() != 15543) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_callback_on_unknown_request() != 5687) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_restsend_sdk_checksum_method_callback_on_conversations_updated() != 38264) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_restsend_sdk_checksum_method_callback_on_conversation_removed() != 60444) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_restsend_sdk_checksum_method_messagecallback_on_sent() != 22337) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_restsend_sdk_checksum_method_syncconversationscallback_on_success() != 35035) {
        return InitializationResult.apiChecksumMismatch
    }
